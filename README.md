...
Install dependencies in the `node_modules/` folder.
...
When the compiler succeeds, then you may still need to fix deprecated code. 
Such as `d3` for the line chart. Or `jszip` for the script backups.
